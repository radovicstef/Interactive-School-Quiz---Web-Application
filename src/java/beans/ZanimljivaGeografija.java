...
public class ZanimljivaGeografija implements Serializable{
    ...
    public void podesiIgruPlaviGlavniCrveni(String username){
        ...
        if(igranapartija!=null){
            igrazanimljivageografija.setIdigranapartija(igranapartija.getIdigranapartija());
            igrazanimljivageografija.setSlovo(slovo);
            igrazanimljivageografija.setUsername1(igranapartija.getUsername1());
            igrazanimljivageografija.setUsername2(igranapartija.getUsername2());
    ...
    public void podesiIgruCrveniGlavniPlavi(String username){
        color="cornflowerblue";
        ...
        if(igranapartija!=null){
            ...
            igrazanimljivageografija.setBrpoena1(0);
            igrazanimljivageografija.setBrpoena2(0);
            //OVO JE PROMENJENO JER IGRA PLAVI
    ...
    public void podesiIgruCrveniGlavniCrveni(String username){
        color="orangered";
        ...
        while(!ready){
            ...
            igrazanimljivageografija=(IgraZgeos)q.add(Restrictions.eq("username2", username)).uniqueResult();
            
            if(igrazanimljivageografija!=null){
                slovo=igrazanimljivageografija.getSlovo();
                ready=true;
                timerstart=true;
            }
    ...
    public void podesiIgruPlaviGlavniPlavi(String username){
        ...
        drzava=null; grad=null; reka=null; jezero=null; planina=null; reka=null; zivotinja=null; biljka=null; grupa=null;
    ...
    public void podesiIgruPlaviOdgPlavi(String username){
        color="cornflowerblue";
        ...
        odgovornaprotivnikovu=true;
        
        boolean ready=false;
        
        drzava=null; grad=null; reka=null; jezero=null; planina=null; reka=null; zivotinja=null; biljka=null; grupa=null;
        disdrzava=true; disgrad=true; disreka=true; disjezero=true; displanina=true; disreka=true; diszivotinja=true; disbiljka=true; disgrupa=true;
        ...
        Criteria q=session.createCriteria(IgraZgeos.class);
        igrazanimljivageografija=(IgraZgeos)q.add(Restrictions.eq("username1", username)).uniqueResult();
        
        if(igrazanimljivageografija.getDrzava()==null){
            disdrzava=false;
        }
        else{
            drzava=igrazanimljivageografija.getDrzava();
        }
        if(igrazanimljivageografija.getGrad()==null){
            disgrad=false;
        }
        else{
            grad=igrazanimljivageografija.getGrad();
        }
        if(igrazanimljivageografija.getReka()==null){
            disreka=false;
        }
        else{
            reka=igrazanimljivageografija.getReka();
        }
        if(igrazanimljivageografija.getJezero()==null){
            disjezero=false;
        }
        else{
            jezero=igrazanimljivageografija.getJezero();
        }
        if(igrazanimljivageografija.getPlanina()==null){
            displanina=false;
        }
        else{
            planina=igrazanimljivageografija.getPlanina();
        }
        if(igrazanimljivageografija.getZivotinja()==null){
            diszivotinja=false;
        }
        else{
            zivotinja=igrazanimljivageografija.getZivotinja();
        }
        if(igrazanimljivageografija.getBiljka()==null){
            disbiljka=false;
        }
        else{
            biljka=igrazanimljivageografija.getBiljka();
        }
        if(igrazanimljivageografija.getGrupa()==null){
            disgrupa=false;
        }
        else{
            grupa=igrazanimljivageografija.getGrupa();
        }
            
        if(disdrzava && disgrad && disreka && disjezero && displanina && diszivotinja && disbiljka && disgrupa){
    ...
    public void podesiIgruCrveniOdgPlavi(String username){
        color="cornflowerblue";
    ...
    public void podesiIgruCrveniOdgCrveni(String username){
        color="orangered";
    ...
    public void podesiIgruPlaviOdgCrveni(String username){
        color="orangered";
    ...
    public void odbrojavajPlaviGlavniCrveni(){
        ...
        if(timer==0){
            System.out.printf("REVIZIJA PLACVI");
            sacekajreviziju=true;
        }
    }
    
    public void odbrojavajCrveniGlavniPlavi(){
        if(!timerstart) return;
        osluskujKrajCrveni();
        if(timer>0){
            timer--;
    ...
    public void odbrojavajCrveniGlavniCrveni(){
        Session session = HibernateUtil.getSessionFactory().openSession();
        Transaction transaction=session.beginTransaction();
    ...
    public void odbrojavajPlaviOdgPlavi(){
        Session session = HibernateUtil.getSessionFactory().openSession();
        Transaction transaction=session.beginTransaction();
        ...
        if(zakljucanodgovor){
            proveriOdgovoreNaOdgovor(1);
        }
    }
    
    public void odbrojavajCrveniOdgPlavi(){
        if(!timerstart) return;
        osluskujKrajCrveniOdgPlavi();
        if(timer>0){
            timer--;
        }
        if(timer==0){
    ...
    public void odbrojavajCrveniOdgCrveni(){
        Session session = HibernateUtil.getSessionFactory().openSession();
        Transaction transaction=session.beginTransaction();
        ...
        if(zakljucanodgovor){
            System.out.printf("ZAKLJUCAN ODGOVARA CRVENI");
            proveriOdgovoreNaOdgovor(2);
        }
    }
    
    public void odbrojavajPlaviOdgCrveni(){
        if(!timerstart) return;
        osluskujKrajPlaviOdgCrveni();
        if(timer>0){
            timer--;
        }
        if(timer==0){
    ...
    public void proveriOdgovoreNaOdgovor(int br){
        ...
        if(igrazanimljivageografija!=null){
        if(igrazanimljivageografija.getDrzava()!=null && !disdrzava){
        ...
        if(igrazanimljivageografija.getGrad()!=null && !disgrad){
        ...
        if(igrazanimljivageografija.getReka()!=null && !disreka){
        ...
        if(igrazanimljivageografija.getJezero()!=null && !disjezero){
        ...
        if(igrazanimljivageografija.getPlanina()!=null && !displanina){
        ...
        if(igrazanimljivageografija.getZivotinja()!=null && !diszivotinja){
        ...
        if(igrazanimljivageografija.getBiljka()!=null && !disbiljka){
        ...
        if(igrazanimljivageografija.getGrupa()!=null && !disgrupa){
        ...
        if(igrazanimljivageografija!=null) igrazanimljivageografija=(IgraZgeos)q2.add(Restrictions.eq("username1", igrazanimljivageografija.getUsername1())).uniqueResult();
        int prethpoeni;
        
        Criteria qpartija=session2.createCriteria(IgranaPartija.class);
        IgranaPartija partija=new IgranaPartija();
        if(igrazanimljivageografija!=null) partija=(IgranaPartija)qpartija.add(Restrictions.eq("username1", igrazanimljivageografija.getUsername1())).uniqueResult();
        if(igrazanimljivageografija!=null){
            if(br==1){
                ...
                int brprethodnihpoena1=partija.getPoeni1();
                int brprethodnihpoena2=partija.getPoeni2();

                brprethodnihpoena1+=igrazanimljivageografija.getBrpoena1();
                brprethodnihpoena2+=igrazanimljivageografija.getBrpoena2();

                partija.setPoeni1(brprethodnihpoena1);
                partija.setPoeni2(brprethodnihpoena2);
            } 
            else{
            ...
            //PRE BRISANJA IGRAZGEOS DODAJEM U PARTIJA BROJ POENA
            int brprethodnizgeos1=partija.getZanimljivageografija1();
            int brprethodnizgeos2=partija.getZanimljivageografija2();

            brprethodnizgeos1+=igrazanimljivageografija.getBrpoena1();
            brprethodnizgeos2+=igrazanimljivageografija.getBrpoena2();

            partija.setZanimljivageografija1(brprethodnizgeos1);
            partija.setZanimljivageografija2(brprethodnizgeos2);

            session2.saveOrUpdate(partija);

            //BRISE SE JER JE ODIGRANA PARTIJA
        ...
        try {
            if(br==1){
                FacesContext.getCurrentInstance().getExternalContext().redirect("zanimljivageografijaplavi2.xhtml");
            }
            else{
                FacesContext.getCurrentInstance().getExternalContext().redirect("peharcrveni.xhtml");
            }
    ...
    public void proveriOdgovoreGlavni(int br){
        ...
        try {
            if(br==2){
                FacesContext.getCurrentInstance().getExternalContext().redirect("zanimljivageografijacrveniodgp.xhtml");
            }
            else{
                FacesContext.getCurrentInstance().getExternalContext().redirect("zanimljivageografijaplaviodgc.xhtml");
            }
        } catch (IOException ex) {
            Logger.getLogger(ZanimljivaGeografija.class.getName()).log(Level.SEVERE, null, ex);
        }
    ...
    public void osluskujKrajPlavi(){
        Session session = HibernateUtil.getSessionFactory().openSession();
        Transaction transaction=session.beginTransaction();

        Criteria q=session.createCriteria(IgraZgeos.class);
        if(igrazanimljivageografija!=null) igrazanimljivageografija=(IgraZgeos)q.add(Restrictions.eq("username2", igrazanimljivageografija.getUsername2())).uniqueResult();
        
        if(igrazanimljivageografija!=null){
            if(igrazanimljivageografija.getKoigra()==0){
                try {
                    FacesContext.getCurrentInstance().getExternalContext().redirect("zanimljivageografijaplaviodgp.xhtml");
                } catch (IOException ex) {
                    Logger.getLogger(ZanimljivaGeografija.class.getName()).log(Level.SEVERE, null, ex);
                }   
            }
